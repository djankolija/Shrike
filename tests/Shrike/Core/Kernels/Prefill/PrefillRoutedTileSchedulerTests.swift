    ...
    @Test func prefillGapLeversDescriptionReportsThePrefetchInEffect() {
        ...
        #expect(RealForwardRunner.prefillGapLeversDescription(
            ...
            == "overlap=on residency=set allocations=24 sweep=fixed cache_layout=pool"
                ...
                + " prefetch=on top_m=8 inflight=2 placement=beside distance=2 adopt=blit join_us=400 probe=fused")
        ...
        #expect(RealForwardRunner.prefillGapLeversDescription(
            ...
            .hasSuffix(" prefetch=on top_m=4 inflight=1 placement=after distance=1 adopt=blit join_us=400 probe=fused"))
