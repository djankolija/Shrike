...
SHRIKE_KERNEL_STATS): the 10 full-attention layers cost 84.3 s of the 133.2 s
...
work, not probe work.
  ...
  ~/.venvs/coreml-py311/bin/python tools/ane-probes/shrike_ane_attention_probe.py
"""
