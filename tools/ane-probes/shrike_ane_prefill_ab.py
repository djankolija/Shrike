...
Arms differ in exactly one variable: SHRIKE_PREFILL_ANE. Fresh server per run,
...
- Output digests are expected to be STABLE WITHIN an arm (greedy) but to
  ...
  python3 tools/ane-probes/shrike_ane_prefill_ab.py --quant 4bit --pairs 1
"""
...
import shrike_gate0_profile as g0
from shrike_profile import (
