    ...
    private var identity: some View {
        VStack(spacing: 10) {
            Image(systemName: "externaldrive.badge.plus")
                ...
                .foregroundStyle(ShrikeMacTheme.accentColor)
                .accessibilityHidden(true)
            Text("Model required")
                .font(.title.bold())
                .accessibilityHeading(.h1)
            Text("Shrike needs \(model.installDescriptor.displayName) before it can generate text.")
                .font(.body)
