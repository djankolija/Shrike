...
public enum ModelThinkingMode: String, Codable, CaseIterable, Sendable {
    ...
    /// runtime through `SHRIKE_THINKING_MODE`. Unknown values retain the
    /// historical safe default of off.
    public static func resolved(
        environment: [String: String] = ProcessInfo.processInfo.environment
    ) -> ModelThinkingMode {
        switch environment["SHRIKE_THINKING_MODE"]?.lowercased() {
...
///
/// Shrike owns the minimal chat framing because the upstream
